...
path_err = 'out/monks/monk3/err_monk3nr'
...
best_model = random_search(model, tr, vl, ts, param_grid=param_grid_nr, max_evals=10, path_results=path_result_randomsearch, verbose=True)
