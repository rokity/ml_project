...
path_loss = 'out/monks/monk3/err_monk3nr.png'
path_acc = 'out/monks/monk3/acc_monk3nr.png'
path_result_model = 'out/monks/monk3/results_nr.csv'
...
for i in range(n_attemps):
    ...
    model.add_layer(dim_hid, input_dim=dim_in, activation='relu', kernel_initialization=RandomUniformInitialization())
    model.add_output_layer(dim_out, activation='sigmoid', kernel_initialization=RandomUniformInitialization())

    model.compile(0.4, 0.6, 0.0)
    history = model.fit(
